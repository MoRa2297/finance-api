...
async function main() {
    ...
    console.log('✅ Category icons seeded (48)');
    ...
    await prisma.bankType.createMany({
        data: [
            ...
            { name: 'Intesa Sanpaolo', imageUrl: 'https://logo.clearbit.com/intesasanpaolo.com' },
            { name: 'UniCredit', imageUrl: 'https://logo.clearbit.com/unicredit.it' },
            { name: 'Fineco', imageUrl: 'https://logo.clearbit.com/finecobank.com' },
            { name: 'Mediolanum', imageUrl: 'https://logo.clearbit.com/bancamediolanum.it' },
            { name: 'BNL', imageUrl: 'https://logo.clearbit.com/bnl.it' },
            { name: 'Monte dei Paschi', imageUrl: 'https://logo.clearbit.com/mps.it' },
    ...
    // ─── CARD TYPES ────────────────────────────────────────────────────────────
    const rawGH = 'https://raw.githubusercontent.com/datatrans/payment-logos/master/assets/cards';
